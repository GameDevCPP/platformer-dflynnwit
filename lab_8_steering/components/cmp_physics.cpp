...
std::vector< b2Contact const*> PhysicsComponent::getTouching() const { //removed const before b2Contact -  duplicate const error message
  std::vector< b2Contact const*> ret; //removed const before b2Contact - duplicate const error message
